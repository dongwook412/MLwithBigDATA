...
class AdmmSolver():
  def __init__(self,model):    
    A=self.A = tf.placeholder(tf.float32, shape = [5, 5, 3, 20])
    B=self.B = tf.placeholder(tf.float32, shape = [5, 5, 3, 20])
    C=self.C = tf.placeholder(tf.float32, shape = [5, 5, 20, 50])
    D=self.D = tf.placeholder(tf.float32, shape = [5, 5, 20, 50])
    E=self.E = tf.placeholder(tf.float32, shape = [5 * 5 * 50, 500])
    F=self.F = tf.placeholder(tf.float32, shape = [5 * 5 * 50, 500])
    G=self.G = tf.placeholder(tf.float32, shape = [500, 100])
    H=self.H = tf.placeholder(tf.float32, shape = [500, 100])
